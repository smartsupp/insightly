...
trait Organisations
{
	...
	public function saveOrganisationAddress($id = false, array $data = [])
	{
		...
		return empty($data['ADDRESS_ID']) ? $this->call('post', 'Organisations/' . $id . '/Addresses', $data) : $this->call('put',
			'Organisations/' . $id . '/Addresses', $data);
	}
	...
	public function saveOrganisationContactInfo($id = false, array $data = [])
	{
		...
		return !empty($data['CONTACT_INFO_ID']) ? $this->call('put', 'Organisations/' . $id . '/ContactInfos', $data) : $this->call('post',
			'Organisations/' . $id . '/ContactInfos', $data);
	}
	...
	public function saveOrganisationDate($id = false, array $data = [])
	{
		...
		return !empty($data['DATE_ID']) ? $this->call('put', 'Organisations/' . $id . '/Dates', $data) : $this->call('post', 'Organisations/' . $id . '/Dates',
			$data);
	}
